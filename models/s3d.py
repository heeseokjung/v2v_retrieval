"""
    Most of the codes are adopted from: https://github.com/kylemin/S3D
"""
...
class S3D(nn.Module):
    ...
    def forward(self, x):
        y = self.base(x)
        y = torch.mean(y, dim=(2, 3, 4)) # avg_pool3d 대신 이거로 수정함

        return y # n_clips x 1024
